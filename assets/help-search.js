// Endless tree structured UL > LI > UL 
  ...
  var treefilter = function(el, options) {
    ...
    var defaults = {
      offsetLeft : 25, // left offset for each level
    ...
    var searcher = function() {
      $(plugin.settings.searcher).keyup(function() {
        if ($(this).val().length == 0) {
          ...
          //     adding class most question sections(custom)      
          plugin.el.parent('.search-section').find(".most-question-part").removeClass("most-question-disable");
          ...
          //     adding class most question sections(custom)      
          plugin.el.parent('.search-section').find(".most-question-part").addClass("most-question-disable");
