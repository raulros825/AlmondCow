...
slate.Variants = (function() {
  ...
  Variants.prototype = _.assignIn({}, Variants.prototype, {
    ...
    _getVariantFromOptions: function() {
      ...
      // Custom Variant for klaviyo form in US/Canada variant of Almond Machine product
//       jQuery.each( selectedValues, function( i, val ) {        
          
//           //console.log(val.value);

//           if (val.value == 'US/Canada'){
//             $('.product--btn-container').css('display', 'none');
//             $('.ac-klaivyo').css('display', 'block');
//           }else{
//             $('.product--btn-container').css('display', 'block');
//             $('.ac-klaivyo').css('display', 'none');
//           }
      
//       });
      // custom variant scripts for almond machine in US/Canada end
...
theme.MobileNav = (function() {
  ...
  function cacheSelectors() {
    cache = {
      ...
      $customMobileLogo: $('.custom_mobile_logo')
    };
  }
  ...
  function closeMobileNav() {
    ...
    cache.$siteHeader.prepareTransition().removeClass(classes.navOpen);
    
    cache.$customMobileLogo.prepareTransition().removeClass(classes.navOpen);
...
theme.Product = (function() {
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initImageSwitch: function() {
      ...
      //       replace Product main image from the thumnail image once click every thumnail images
...
//         self._switchImage(imageSrc, zoomSrc);
      ...
      //Product image Zoom
      $('.product-single__photos button').click(function(){
        var img_src = $('.slick-active img').attr('src');
        var z_src = $('.slick-active img').data('zoom');
        $('.zoomImg').attr('src', z_src);
        //self._setActiveThumbnail(img_src);
      });
      
//       replace Product main image from the thumnail image once hover every thumnail images
//       $(this.selectors.productThumbImages).mouseover(function(evt) {
//         evt.preventDefault();
//         var $el = $(this);
//         var imageSrc = $el.attr('href');
//         var zoomSrc = $el.data('zoom');
...
// custom js part start

$(document).ready(function () {
  
  //   multiple currency triggers
  ...
  $("#home-poster-video-button>img").hover(
    function() {
      $("#home-poster-video-button>img:first-child").css("display", "none");
      $("#home-poster-video-button>img:nth-child(2)").css("display", "block");
    }, function() {
      $("#home-poster-video-button>img:first-child").css("display", "block");
      $("#home-poster-video-button>img:nth-child(2)").css("display", "none");
    }
  );

  //   Video Cover
  $('#home-poster-video').on('click', function(ev) {

    $("#home-poster-video").css({"display": "none"});
    $("#home-poster-video-button").css({"display": "none"});
    $("#vimeo_video")[0].src += "?autoplay=1&loop=1&autopause=0";
    ev.preventDefault();

  });
  $('#home-poster-video-button').on('click', function(ev) {
...
//    nav dropdown function  
  $('li.site-nav--has-dropdown').hover(function(){
    $(this).find('.site-nav__dropdown').show();
  },function(){
    $(this).find('.site-nav__dropdown').hide();
  });
  $('div.site-nav__dropdown').hover(function(){
    $(this).find('.site-nav__dropdown').show();
  },function(){
    $(this).find('.site-nav__dropdown').hide();
  });
  ...
  if(windowWidth>749){
    $(function() {
      $('.scroll-down-btn').on('click', function(e) {
        ...
        var header_length = parseInt($('.custom_mobile_nav').css('height'));
        var scroll_height = top - header_length;
        $('html, body').animate({ scrollTop: scroll_height}, 500, 'linear');
      });
    });
  } else {
    $('.scroll-down-btn').on('click', function(e) {
...
//     $('.accordion > li:eq(0)>a').addClass('active').next().slideDown();
    ...
    $('.accordion>li>a').click(function(j) {
      var dropDown = $(this).closest('li').find('.accordion_text');

      $(this).closest('.accordion').find('.accordion_text').not(dropDown).slideUp();
...
//   new quantity box(snippets/quantity-box.liquid)
  ...
  $('.modal-popup').on('click', function(e) {
    e.preventDefault();
    $('.ingredient-modal').toggleClass('is-visible');
  });

  $('.modal-popup1').on('click', function(e) {
    e.preventDefault();
    $('.ingredient-modal1').toggleClass('is-visible');
  });

  $('.modal-popup2').on('click', function(e) {
    e.preventDefault();
    $('.ingredient-modal2').toggleClass('is-visible');
  });
  
  $('.modal-popup3').on('click', function(e) {
    e.preventDefault();
    $('.ingredient-modal3').toggleClass('is-visible');
  });
  ...
  // slider - product-card-grid-slider.liquid
  $('.product-card-slider').each(function(i){ 
    $(this).slick({
      dots: true,
  ...
  // slider - ingredients-modal.liquid
  $('.ingredients-modal-slider').each(function(i){
    $(this).slick({
      dots: true,
      prevArrow: $(this).parent().find('.ingredient-slick-prev'),
      nextArrow: $(this).parent().find('.ingredient-slick-next'),
      infinite: true,
      lazyLoad: 'ondemand',
      swipe:true,
      autoplay: false,
  ...
  if(window.location.href == 'https://almondcow.co/collections/all' 
     || window.location.href == 'https://almondcow.co/collections' 
     || window.location.href == 'https://almondcow.co/collections/almond-cow-glass-jug-upsell'
     || window.location.href == 'https://almondcow.co/collections/almond-cow-glass-jug-6-pack-upsell'
    )
  {
...
$(document).scroll(function(){
  ...
  var windowWidth = $(window).width();
  var y1 = 0;
  var y2 = parseInt(jQuery('#shopify-section-header').css('height'));
  if(windowWidth>749){
    //Your script if device width is up 749px


    if(scroll_h > y1){
      jQuery('#shopify-section-header').addClass("sticky-header");
      jQuery('.main-content').css({"padding-top": y2});
    } else{
      jQuery('#shopify-section-header').removeClass("sticky-header");
